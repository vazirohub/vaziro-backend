...
class NotificationService {
    static resendApiKey = config_1.config.resend.apiKey;
    static defaultSender = config_1.config.resend.fromEmail;
    static frontendBaseUrl = config_1.config.frontendUrl;
    /**
